...
export const uz: Translation = {
  ...
  home: {
    ...
    deals: 'Chegirmalar va aksiyalar',
    dealsSubtitle: 'Ommabop texnikaga eng yaxshi narxlar',
    popular: 'Ommabop mahsulotlar',
    popularSubtitle: 'Xaridorlar reytingi bo‘yicha tanlangan',
    slideSale: 'Chegirma',
    slidePrev: 'Oldingi slayd',
    slideNext: 'Keyingi slayd',
    slideGoto: 'Slaydga o‘tish',
  ...
  admin: {
    ...
    price: 'Narx',
    oldPrice: 'Eski narx',
    oldPriceHint: 'Chegirma uchun — joriy narxdan yuqori. Bo‘sh = chegirmasiz.',
    stock: 'Qoldiq',
    category: 'Kategoriya',
    brand: 'Brend',
