...
export const en: Translation = {
  ...
  home: {
    ...
    dealsSubtitle: 'Best prices on popular tech',
    popular: 'Popular products',
    popularSubtitle: 'Picked by customer rating',
    slideSale: 'Sale',
    slidePrev: 'Previous slide',
    slideNext: 'Next slide',
    slideGoto: 'Go to slide',
  ...
  admin: {
    ...
    price: 'Price',
    oldPrice: 'Old price',
    oldPriceHint: 'For a discount — higher than the current price. Empty = no discount.',
    stock: 'Stock',
    category: 'Category',
    brand: 'Brand',
